async function drawMap_locations() {
    ...
    const LGA_map = await d3.json("./../geo/nsw_lga.json")

    console.log(LGA_map)

    // SA3_map.objects.SA3.geometries = SA3_map.objects.SA3.geometries.filter(d => d.properties.SA3_NAME16 == "Sydney Inner City" || d.properties.SA3_NAME16 == "Eastern Suburbs - North")
// 
...
//     SA2_map.objects.SA2.geometries = SA2_map.objects.SA2.geometries.filter(d => d.properties.SA3_NAME16 == "Sydney Inner City" || d.properties.SA3_NAME16 == "Eastern Suburbs - North")
...
//         const x = projection_SA3([d.lon, d.lat])[0]
//         const y = projection_SA3([d.lon, d.lat])[1]
